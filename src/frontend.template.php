...
<title>Joyabo Disposable Temporary Mailbox</title>
...
<header>
  <div class="container">
    <a href="https://www.joyabo.com/" title="Joyabo Temporary Disposable Mailbox" target="_top"><img src="https://static.joyabo.com/logo/joyabo-logo-01-transparent-483x200.png" width="193" height="80" border="0"></a>
    ...
    <div class="row" id="address-box-normal">
      <div class="col my-address-block">
        <span id="my-address"><?php echo $user->address ?></span><br><button class="copy-button" data-clipboard-target="#my-address">Copy my temporary email address</button>
      </div>
      <div class="col get-new-address-col">
        <button type="button" class="btn btn-outline-dark"
          ...
          <i class="fas fa-magic"></i> Change email address
        </button>
      </div>
    </div>
        ...
        <div class="card-body">
          ...
          <div class="form-row align-items-center">
            ...
            <div class="col-auto my-1">
              <button type="submit" class="btn btn-primary">Get mailbox</button>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    ...
    <p>
      <small>
        ...
        <br>
        Copyright &copy; <?php echo date("Y"); ?> <a href="https://www.joyabo.com/" title="Joyabo Disposable Mailbox" target="_top">Joyabo</a>. All Rights Reserved.
      </small>
    </p>
  </div>
</footer>
